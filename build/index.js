...
}, Object(_util_helpers__WEBPACK_IMPORTED_MODULE_2__["generateTypographyAttributes"])(Object.values(_constants_typographyPrefixConstants__WEBPACK_IMPORTED_MODULE_1__))), Object(_util_helpers__WEBPACK_IMPORTED_MODULE_2__["generateResponsiveRangeAttributes"])(_constants__WEBPACK_IMPORTED_MODULE_0__["imageHeight"], {
  noUnits: true
})), Object(_util_helpers__WEBPACK_IMPORTED_MODULE_2__["generateResponsiveRangeAttributes"])(_constants__WEBPACK_IMPORTED_MODULE_0__["imageWidth"], {
  noUnits: true
})), Object(_util_helpers__WEBPACK_IMPORTED_MODULE_2__["generateDimensionsAttributes"])(_constants__WEBPACK_IMPORTED_MODULE_0__["wrapperMargin"], {
  top: 28,
  right: 0,
  bottom: 28,
  left: 0,
  isLinked: false
})), Object(_util_helpers__WEBPACK_IMPORTED_MODULE_2__["generateDimensionsAttributes"])(_constants__WEBPACK_IMPORTED_MODULE_0__["wrapperPadding"])), Object(_util_helpers__WEBPACK_IMPORTED_MODULE_2__["generateBorderShadowAttributes"])(_constants__WEBPACK_IMPORTED_MODULE_0__["imageBorderShadow"]));
...
/*!********************************!*\
  !*** ./src/constants/index.js ***!
  \********************************/
/*! exports provided: EFFECTS_LIST, WRAPPER_UNITS, IMAGE_HEIGHT, IMAGE_WIDTH, ALIGNMENT, imageHeight, imageWidth, wrapperMargin, wrapperPadding, wrapperBorderShadow, imageBorderShadow */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EFFECTS_LIST", function() { return EFFECTS_LIST; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WRAPPER_UNITS", function() { return WRAPPER_UNITS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IMAGE_HEIGHT", function() { return IMAGE_HEIGHT; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "IMAGE_WIDTH", function() { return IMAGE_WIDTH; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "imageBorderShadow", function() { return imageBorderShadow; });
var __ = wp.i18n.__;
...
var imageWidth = "imgWidth"; // responsive dimension controller

var wrapperMargin = "wrpMargin";
var wrapperPadding = "wrpPadding"; // border & shadow

var wrapperBorderShadow = "wrpBrdShdw";
var imageBorderShadow = "imgBrdShdw";
...
var typoPrefix_header = "headerText";
var typoPrefix_content = "contentText";
...
var Edit = function Edit(props) {
  ...
  var blockMeta = attributes.blockMeta,
      ...
      isBackgroundGradient = attributes.isBackgroundGradient,
  ...
  var _generateDimensionsCo2 = Object(_util_helpers__WEBPACK_IMPORTED_MODULE_4__["generateDimensionsControlStyles"])({
    ...
    attributes: attributes
      ...
      wrapperPaddingStylesMobile = _generateDimensionsCo2.dimensionStylesMobile; //header typography


  var _generateTypographySt = Object(_util_helpers__WEBPACK_IMPORTED_MODULE_4__["generateTypographyStyles"])({
    attributes: attributes,
    prefixConstant: _constants_typographyPrefixConstants__WEBPACK_IMPORTED_MODULE_3__["typoPrefix_header"]
  }),
      headerTypoStylesDesktop = _generateTypographySt.typoStylesDesktop,
      headerTypoStylesTab = _generateTypographySt.typoStylesTab,
      headerTypoStylesMobile = _generateTypographySt.typoStylesMobile; //Content typography
  ...
  var _generateTypographySt2 = Object(_util_helpers__WEBPACK_IMPORTED_MODULE_4__["generateTypographyStyles"])({
    ...
    prefixConstant: _constants_typographyPrefixConstants__WEBPACK_IMPORTED_MODULE_3__["typoPrefix_content"]
      ...
      contentTypoStylesMobile = _generateTypographySt2.typoStylesMobile; // image height


  var _generateResponsiveRa = Object(_util_helpers__WEBPACK_IMPORTED_MODULE_4__["generateResponsiveRangeStyles"])({
    controlName: _constants__WEBPACK_IMPORTED_MODULE_2__["imageHeight"],
    property: "height",
    attributes: attributes,
    customUnit: "px"
  }),
      imageHeightDesktop = _generateResponsiveRa.rangeStylesDesktop,
      imageHeightTab = _generateResponsiveRa.rangeStylesTab,
      imageHeightMobile = _generateResponsiveRa.rangeStylesMobile; // image width


  var _generateResponsiveRa2 = Object(_util_helpers__WEBPACK_IMPORTED_MODULE_4__["generateResponsiveRangeStyles"])({
    controlName: _constants__WEBPACK_IMPORTED_MODULE_2__["imageWidth"],
    property: "max-width",
    attributes: attributes,
    customUnit: "px"
  }),
      imageWidthDesktop = _generateResponsiveRa2.rangeStylesDesktop,
      imageWidthTab = _generateResponsiveRa2.rangeStylesTab,
      imageWidthMobile = _generateResponsiveRa2.rangeStylesMobile;

  var _generateBorderShadow = Object(_util_helpers__WEBPACK_IMPORTED_MODULE_4__["generateBorderShadowStyles"])({
    controlName: _constants__WEBPACK_IMPORTED_MODULE_2__["imageBorderShadow"],
    attributes: attributes
  }),
      imageBdShadowStyesDesktop = _generateBorderShadow.styesDesktop,
      imageBdShadowStyesTab = _generateBorderShadow.styesTab,
      imageBdShadowStyesMobile = _generateBorderShadow.styesMobile,
      imageBdShadowStylesHoverDesktop = _generateBorderShadow.stylesHoverDesktop,
      imageBdShadowStylesHoverTab = _generateBorderShadow.stylesHoverTab,
      imageBdShadowStylesHoverMobile = _generateBorderShadow.stylesHoverMobile,
      imageBdShadowTransitionStyle = _generateBorderShadow.transitionStyle;

  var imageAlign = imageAlignment === "left" ? "margin: 0;" : imageAlignment === "right" ? "margin: 0 0 0 auto;" : "margin: 0 auto;";
  var desktopStyles = "\n\t\t.eb-interactive-promo-wrapper.".concat(blockId, " {\n\t\t\t").concat(wrapperMarginStylesDesktop, "\n\t\t\t").concat(wrapperPaddingStylesDesktop, "\n\t\t}\n\n\t\t.eb-interactive-promo-wrapper.").concat(blockId, " .eb-interactive-promo-header {\n\t\t\t").concat(headerTypoStylesDesktop, "\n\t\t\t").concat(headerColor ? "color: ".concat(headerColor, ";") : "", "\n\t\t}\n\n\t\t.eb-interactive-promo-wrapper.").concat(blockId, " .eb-interactive-promo-content {\n\t\t\t").concat(contentTypoStylesDesktop, "\n\t\t\tcolor: ").concat(contentColor, ";\n\t\t}\n\n\t\t.eb-interactive-promo-wrapper.").concat(blockId, " .eb-interactive-promo figure {\n\t\t\t").concat(imageHeightDesktop.replace(/\D/g, "") ? imageHeightDesktop : "height: 100%;", "\n\t\t\t").concat(imageWidthDesktop.replace(/\D/g, "") ? imageWidthDesktop : "max-width: 100%;", "\n\t\t\t").concat(imageBdShadowStyesDesktop, "\n\t\t\t").concat(imageAlign, "\n\t\t\t").concat(isBackgroundGradient ? "background: ".concat(backgroundGradient, ";") : backgroundColor ? "background: ".concat(backgroundColor, ";") : "", "\n\t\t\twidth: 100%;\n\t\t\tposition: relative;\n\t\t\toverflow: hidden;\n\t\t\ttransition: ").concat(imageBdShadowTransitionStyle, ";\n\t\t}\n\t\t\n\t\t.eb-interactive-promo-wrapper.").concat(blockId, " .eb-interactive-promo:hover figure {\n\t\t\t").concat(imageBdShadowStylesHoverDesktop, "\n\t\t}\n\n\t\t.eb-interactive-promo-wrapper.").concat(blockId, " .eb-interactive-promo figure img {\n\t\t\tmin-width: 100%;\n\t\t}\n\t");
  var tabStyles = "\n\t\t.eb-interactive-promo-wrapper.".concat(blockId, " {\n\t\t\t").concat(wrapperMarginStylesTab, "\n\t\t\t").concat(wrapperPaddingStylesTab, "\n\t\t}\n\n\t\t.eb-interactive-promo-wrapper.").concat(blockId, " .eb-interactive-promo-header {\n\t\t\t").concat(headerTypoStylesTab, "\n\t\t}\n\n\t\t.eb-interactive-promo-wrapper.").concat(blockId, " .eb-interactive-promo-content {\n\t\t\t").concat(contentTypoStylesTab, "\n\t\t}\n\n\t\t.eb-interactive-promo-wrapper.").concat(blockId, " .eb-interactive-promo figure {\n\t\t\t").concat(imageHeightTab.replace(/\D/g, "") ? imageHeightTab : "height: 100%;", "\n\t\t\t").concat(imageWidthTab.replace(/\D/g, "") ? imageWidthTab : "max-width: 100%;", "\n\t\t\t").concat(imageBdShadowStyesTab, "\n\t\t}\n\n\t\t.eb-interactive-promo-wrapper.").concat(blockId, " .eb-interactive-promo:hover figure {\n\t\t\t").concat(imageBdShadowStylesHoverTab, "\n\t\t}\n\t");
  var mobileStyles = "\n\t\t.eb-interactive-promo-wrapper.".concat(blockId, " {\n\t\t\t").concat(wrapperMarginStylesMobile, "\n\t\t\t").concat(wrapperPaddingStylesMobile, "\n\t\t}\n\t\t\n\t\t.eb-interactive-promo-wrapper.").concat(blockId, " .eb-interactive-promo-header {\n\t\t\t").concat(headerTypoStylesMobile, "\n\t\t}\n\n\t\t.eb-interactive-promo-wrapper.").concat(blockId, " .eb-interactive-promo-content {\n\t\t\t").concat(contentTypoStylesMobile, "\n\t\t}\n\n\t\t.eb-interactive-promo-wrapper.").concat(blockId, " .eb-interactive-promo figure {\n\t\t\t").concat(imageHeightMobile.replace(/\D/g, "") ? imageHeightMobile : "height: 100%;", "\n\t\t\t").concat(imageWidthMobile.replace(/\D/g, "") ? imageWidthMobile : "max-width: 100%;", "\n\t\t\t").concat(imageBdShadowStyesMobile, "\n\t\t}\n\n\t\t.eb-interactive-promo-wrapper.").concat(blockId, " .eb-interactive-promo:hover figure {\n\t\t\t").concat(imageBdShadowStylesHoverMobile, "\n\t\t}\n\t"); // all css styles for large screen width (desktop/laptop) in strings ⬇
  ...
  return [isSelected && /*#__PURE__*/React.createElement(_inspector__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...
    className: "eb-interactive-promo-wrapper ".concat(blockId)
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, content), link && /*#__PURE__*/React.createElement("a", {
    href: link,
...
var Inspector = function Inspector(_ref) {
  ...
  var resOption = attributes.resOption,
      ...
      isBackgroundGradient = attributes.isBackgroundGradient,
      backgroundColor = attributes.backgroundColor,
      backgroundGradient = attributes.backgroundGradient; // this useEffect is for setting the resOption attribute to desktop/tab/mobile depending on the added 'eb-res-option-' class only the first time once
  ...
  return /*#__PURE__*/React.createElement(InspectorControls, {
    ...
    return /*#__PURE__*/React.createElement("div", {
    ...
    }), imageURL && /*#__PURE__*/React.createElement(_util_image_avatar__WEBPACK_IMPORTED_MODULE_2__["default"], {
      imageUrl: imageURL,
      ...
      controlName: _constants__WEBPACK_IMPORTED_MODULE_0__["imageHeight"],
      ...
      controlName: _constants__WEBPACK_IMPORTED_MODULE_0__["imageWidth"],
      resRequiredProps: resRequiredProps,
      min: 0,
      max: 1000,
      step: 1,
    ...
    }, __("Alignment", "interactive-promo")), /*#__PURE__*/React.createElement(ButtonGroup, null, _constants__WEBPACK_IMPORTED_MODULE_0__["ALIGNMENT"].map(function (item) {
      return /*#__PURE__*/React.createElement(Button, {
        isLarge: true,
      ...
      value: effectName,
      options: _constants__WEBPACK_IMPORTED_MODULE_0__["EFFECTS_LIST"],
      onChange: function onChange(newEffect) {
        return setAttributes({
          effectName: newEffect
        });
      }
    }))), tab.name === "styles" && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(PanelBody, null, /*#__PURE__*/React.createElement(BaseControl, null, /*#__PURE__*/React.createElement("h3", {
      className: "eb-control-title"
    }, __("Background Color", "interactive-promo"))), /*#__PURE__*/React.createElement(ToggleControl, {
    ...
    }), isBackgroundGradient || /*#__PURE__*/React.createElement(_util_color_control__WEBPACK_IMPORTED_MODULE_4__["default"], {
    ...
    }), isBackgroundGradient && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_util_gradient_color_controller__WEBPACK_IMPORTED_MODULE_9__["default"], {
      ...
      initialOpen: false
    }, /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_util_typography_control_v2__WEBPACK_IMPORTED_MODULE_6__["default"], {
      baseLabel: __("Typography"),
      typographyPrefixConstant: _constants_typographyPrefixConstants__WEBPACK_IMPORTED_MODULE_1__["typoPrefix_header"],
      resRequiredProps: resRequiredProps
      ...
      baseLabel: __("Typography"),
      typographyPrefixConstant: _constants_typographyPrefixConstants__WEBPACK_IMPORTED_MODULE_1__["typoPrefix_content"],
      resRequiredProps: resRequiredProps
    }), /*#__PURE__*/React.createElement(_util_color_control__WEBPACK_IMPORTED_MODULE_4__["default"], {
      label: __("Color"),
      color: contentColor,
    ...
    })))), tab.name === "advance" && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(PanelBody, null, /*#__PURE__*/React.createElement(_util_dimensions_control_v2__WEBPACK_IMPORTED_MODULE_7__["default"], {
      resRequiredProps: resRequiredProps,
      ...
      controlName: _constants__WEBPACK_IMPORTED_MODULE_0__["imageBorderShadow"],
      resRequiredProps: resRequiredProps
    }))));
  })));
};
